...
# =============================================Fault================================================
    if page =='Faults':
        ...
        df = fetch_file('Fault 2022-02-18 151008.xlsx')
...
#--------------------------------------- color & width & opacity----------------------------------------------
     ...
     #---------------------------------------------KPI Monitoring-------------------------------------------------------
        ...
        df4 = df3.loc[:, ['Site', 'Building', 'Level', 'Building_Trade', 'Trade_Category', 'Type_of_Fault',  # need remove room here cos room is empty seems like 0
                          'Time_Acknowledged_hrs', 'Time_Site_Reached_hrs', 'Time_Work_Started_hrs',
                          'Time_Work_Recovered_hrs']]
        df4 = df4[['Site', 'Building', 'Level', 'Building_Trade', 'Trade_Category', 'Type_of_Fault',
    ...
    ## groupby building level room(no room at this moment)
...
# =======================================================================================Inventories=========================================================================================
    if page =='Inventories':
        ...
        df_ALH_t = pd.read_excel('Transaction 2022-02-18 151557.xlsx', header=1, usecols=trans_cols, parse_dates=date)
        ...
        df_ALH_balance = pd.read_excel('Inventories 2022-02-18 151712.xlsx', header=1, usecols=balance_cols)
